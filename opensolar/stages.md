...
Some projects can skips some stages if they are not relevant to the project. For example, a donation project where the contractor and developer is the entity who's donating the energy grid might not have stages 1, 2, and 3.
